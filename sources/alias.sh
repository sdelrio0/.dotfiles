...
alias rdca="rails db:create:all"
alias rdc="rails db:create"
alias seed="rails db:seed"
alias sneakers="bundle exec rake sneakers:run"
...
# Config
alias cz="vim ~/.dotfiles/dotfiles/.zshrc"
...
# Webpages
alias github="open -a Google\ Chrome 'https://github.com/sdelrio0'"
